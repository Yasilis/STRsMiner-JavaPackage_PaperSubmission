...
public class ThreadWorkerForCalculatingGeneBasedHomologyForCase implements Callable<HashMap<String, ArrayList<Integer>>>
{
    ...
    public ThreadWorkerForCalculatingGeneBasedHomologyForCase(
    ...
    public HashMap<String, ArrayList<Integer>> call() throws Exception
    {
        ...
        System.out.println("$ :: The process of calculate gene based homology for case gene "
        ...
        for (Transcript transcript : candidateTranscriptsStableIDs)
        {
            ...
            sequences.retainAll(calculatedUniqueSTRs.get(speciesID));
